package com.xtruong.scanner.behavior;
 ...
 */
public final class BottomNavigationFloatingButtonBehavior  extends CoordinatorLayout.Behavior<FloatingActionButton> {

    public BottomNavigationFloatingButtonBehavior(@Nullable Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
