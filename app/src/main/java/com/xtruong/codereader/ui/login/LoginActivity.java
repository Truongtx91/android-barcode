package com.xtruong.codereader.ui.login;
...
import com.xtruong.codereader.BarCodeApp;
import com.xtruong.codereader.R;
import com.xtruong.codereader.data.DatabaseHandler;
import com.xtruong.codereader.data.SessionManager;
import com.xtruong.codereader.ui.barcode.BarcodeActivity;
import com.xtruong.codereader.utils.AppConfig;
import com.xtruong.codereader.utils.Functions;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (session.isLoggedIn()) {
            Intent i = new Intent(LoginActivity.this, BarcodeActivity.class);
            startActivity(i);
            finish();
        }
    ...
    private void loginProcess(final String email, final String password) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        if(Integer.parseInt(json_user.getString("verified")) == 1){
                            ...
                            Intent upanel = new Intent(LoginActivity.this, BarcodeActivity.class);
                            ...
                            Intent upanel = new Intent(LoginActivity.this, EmailVerifyActivity.class);
                            upanel.putExtras(b);
                            upanel.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                            startActivity(upanel);
                            finish();
        ...
        BarCodeApp.getInstance().addToRequestQueue(strReq, tag_string_req);
    }
